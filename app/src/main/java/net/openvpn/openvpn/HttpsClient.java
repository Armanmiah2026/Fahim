...
public class HttpsClient {
    ...
    public static class AuthContext {
        private CR cr;
        private String hostname = BuildConfig.FLAVOR;
    ...
    public static abstract class Task implements Runnable {
        ...
        protected static class ErrorDialogException extends Exception {
            ...
            public void dispatch(Interact inter) {
    ...
    public static void run_task(Context context, Task task, HttpsClient.CancelDetect.I cancel_source, Runnable on_fail, boolean enable_cert_dialog, boolean enable_trust_error_dialog, long max_download_size) {
