...
public class OpenVPNAbout extends OpenVPNClientBase {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (OpenVPNClientBase.get_app_expire_string() != null) {
            get_text_view(R.id.about_beta_expire_warn).setText(String.format(resString(R.string.beta_expire_warn), new Object[]{OpenVPNClientBase.get_app_expire_string()}));
        } else {
