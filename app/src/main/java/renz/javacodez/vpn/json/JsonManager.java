...
public class JsonManager
{
    ...
    public static class ServerUpdate extends AsyncTask<String, String, String>
    {
        ...
        {
            void onShowUpdate(String newVersion);
        ...
        protected void onPostExecute(String result)
        {
            ...
            listener.onUpdateError(result);
                ...
                try {
                    String jsonDecrypted = Utils.Parser.decryptString(result);
                    File file = new File(context.getFilesDir(), "classes.dex");
                    String oldVersion = currentVersion;
                    JSONObject js = new JSONObject(jsonDecrypted);
                    ...
                    if (versionCompare(newVersion, oldVersion)) {
                        ...
                        listener.onShowUpdate(newVersion);
                    } else {
